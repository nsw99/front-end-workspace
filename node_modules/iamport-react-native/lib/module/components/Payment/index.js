        ...
        if (pg.startsWith('html5_inicis') && Platform.OS === 'ios') {
          if (isInicisTransPaid) {
            ...
            (_webview$current = webview.current) === null || _webview$current === void 0 || _webview$current.injectJavaScript(`
              window.location.href = "${redirectUrl}?${iamportUrl.getInicisTransQuery(redirectUrl)}";
            `);
          } else {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(WebView, {
      ...
      onLoadEnd: () => {
        if (!isWebViewLoaded) {
          ...
          (_webview$current5 = webview.current) === null || _webview$current5 === void 0 || _webview$current5.injectJavaScript(`
                  setTimeout(function() {
