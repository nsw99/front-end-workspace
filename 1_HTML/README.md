...
- 대표적인 블럭 태그는 div, p, pre, hr, table태그 등이 있다.
...
- 해당 페이지에서 나타내고자 하는 내용 작성한다.

## section

- 단락, 이미지, 제목등의 콘텐츠를 묶어 더 큰 논리적 단위 형성한다.
- class나 id 속성을 사용하여 섹션을 구분한다.


## article

- 페이지 내용상 별개의 내용을 구성할 때 사용되는 섹션이다.

## aside

- 본문 내용에 대한 추가적인 설명, 부수적 콘텐츠 표시에 사용하는 태그이다.
...
- 이미지에 대한 캡션이나 설명을 위한 태그이다.
- 문서의 흐름에 영향을 주지 않는 마크업에도 사용한다.
